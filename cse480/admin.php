    ...
    <section class="banner-bottom-w3ls py-lg-5 py-md-5 py-3">
        <div class="container">
            <div class="inner-sec-w3layouts py-lg-5 py-3">
                ...
                <h5 class="tittle text-center mb-md-5 mb-4">Delivar Product</h5>
                        ...
                        if(mysqli_num_rows($result) > 0){ ?>
                           ...
                           <?php while($row = mysqli_fetch_array($result)){ ?>
                                <tr>
                                    ...
                                    <td><a href="adminupdate.php?delivar=<?php echo $row['id']; ?>"><input class="btn btn-primary btn-small" value="DELIVAR" type="submit" name="DELIVAR"></a></td>
                                <?php }?>
                                </tr>
                         <?php   }
                            echo "</table>";
